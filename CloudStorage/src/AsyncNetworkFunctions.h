...
void asyncAuthorization(UI::MainWindow& ref, std::unique_ptr<streams::IOSocketStream<char>>& clientStream, std::wstring& login, std::wstring& password, bool& isCancel);

void asyncFirstConnect(UI::MainWindow& ref, std::unique_ptr<streams::IOSocketStream<char>>& clientStream, bool& isCancel);