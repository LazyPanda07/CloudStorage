...
namespace responses
{
	inline const std::string noConnectionWithFilesServer = "Не удалось установить соединение с файловым сервером";
	inline const std::string noConnectionWithDataBaseServer = "Не удалось установить соединение с сервером базы данных";
